...
<body>
    ...
    <main>
        <section class="news-container">
            ...
            <?php
            require 'config.php';
            $sql = "SELECT * FROM vijesti WHERE category='tehnologija'";
            ...
            <div class='news-item'>
                <h2>AJMO DA TEBE VIDIMO</h2>
                <p>aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</p>
                <div class='news-image'><img src='images/slika5.jpg' alt='AJMO DA TEBE VIDIMO'></div>
            </div>
        </section>
    </main>
    <footer>
